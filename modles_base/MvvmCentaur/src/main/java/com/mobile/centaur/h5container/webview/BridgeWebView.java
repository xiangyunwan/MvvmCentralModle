...
public class BridgeWebView extends WebView implements WebViewJavascriptBridge, WebViewTitleControl {
...
//    }
    ...
    public void onPageFinished(boolean canGoBack) {
        if (closeView != null) {
            closeView.setVisibility(canGoBack ? View.VISIBLE : View.GONE);
