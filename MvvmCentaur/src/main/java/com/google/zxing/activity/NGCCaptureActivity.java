 ...
 * @author ZZZ
 */
public class NGCCaptureActivity extends AppCompatActivity implements Callback {
        ...
        if (requestCode == RESULT_OK) {
            switch (requestCode) {
                case REQUEST_CODE_SCAN_GALLERY:
                    ...
                    mProgress = new ProgressDialog(NGCCaptureActivity.this);
...
//                                bundle.putParcelable("bitmap",result.get);
                                ...
                                NGCCaptureActivity.this.setResult(RESULT_CODE_QR_SCAN, resultIntent);
...
//		});
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            Toast.makeText(NGCCaptureActivity.this, "Scan failed!", Toast.LENGTH_SHORT).show();
        } else {
            Intent resultIntent = new Intent();
            Bundle bundle = new Bundle();
