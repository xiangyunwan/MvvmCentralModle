...
public class GlideUtils {
     ...
     *加载图片(默认)
     */
    public static void loadImageInSide(Context context, String url, ImageView imageView, @DrawableRes int defaultImage) {
        RequestOptions options = new RequestOptions()
                .centerInside()
                .placeholder(placeholderSoWhite) //占位图
                .error(defaultImage)       //错误图
                // .priority(Priority.HIGH)
                .diskCacheStrategy(DiskCacheStrategy.ALL);
        Glide.with(context).load(url).apply(options).into(imageView);
    }
     ...
     *加载图片(默认)
     */
    public static void loadImageCenterCrop(Context context, String url, ImageView imageView, @DrawableRes int defaultImage) {
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .placeholder(placeholderSoWhite) //占位图
                .error(defaultImage)       //错误图
     ...
     * 加载圆角图片
     */
    public static void loadRoundCircleImage(Context context, String url, int radius, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .circleCrop()//设置圆形
                .placeholder(placeholderSoWhite)
    ...
    public static void loadCustRoundCircleImage(Context context, String url, ImageView imageView, RoundedCornersTransformation.CornerType type) {
        MultiTransformation multiTop = new MultiTransformation(
                new CenterCrop(),
                new RoundedCornersTransformation(25, 0, type));
...
//                .bitmapTransform(new RoundedCornersTransformation(45, 0, type))
                .apply(bitmapTransform(multiTop))
                .diskCacheStrategy(DiskCacheStrategy.ALL);
        Glide.with(context).load(url).apply(options).into(imageView);
    }
     ...
     * @param type
     */
    public static void loadCustRoundCircleImage(Context context, String url, ImageView imageView, @DrawableRes int defaultImage, RoundedCornersTransformation.CornerType type) {
        MultiTransformation multiTop = new MultiTransformation(
                new CenterCrop(),
                new RoundedCornersTransformation(20, 0, type));
...
//                    });
     ...
     * @param imageView
     */
    public static void loadLocalRoundImage(Context context, @DrawableRes int id, int radius, ImageView imageView, RoundedCornersTransformation.CornerType type) {
        MultiTransformation multiTop = new MultiTransformation(
                new CenterCrop(),
                new RoundedCornersTransformation(20, 0, type));
...
//                .bitmapTransform(new RoundedCornersTransformation(45, 0, type))
     ...
     * @param imageView
     */
    public static void loadLocalImage(Context context, int id, ImageView imageView) {
     ...
     * @param imageView
     */
    public static void loadLocalImageAsBitmap(Context context, int id, ImageView imageView) {
        Glide.with(context).asBitmap().load(id).into(imageView);
    }
     ...
     * @param url
     */
    public static void loadUrlImageAsBitmap(Context context, String url, RequestListener listrener) {
        Glide.with(context).asBitmap().load(url).addListener(listrener);
    }
}
